 ...
 * 
 * We need to wait until the helloworldendpoints API has loaded to enable the
 * actions for the buttons in index.html, because the buttons call functions in
 * the helloworldendpoints API
 */
...
function enableButtons() {
	...
	btn.value = "Click me for a timed greeting";
}
...
/*
 * Execute a request to the sayHelloByName() endpoints function. Illustrates
 * calling an endpoints function that takes an argument.
 */
...
/*
 * Execute a request to sayHelloByPeriod() endpoints function Illustrates
 * calling an endpoints function that takes an argument
 */
